...
<section class="block block-content-columns block-accessibility image-left">
  <div class="container">
    ...
    <div class="col col-image" aria-hidden="true">
      <div class="wrapper">
        <p>
          <span class="pre-label">This regular external link</span>
          <a href="https://github.com/digitoimistodude/air-light">Air-light GitHub</a>
        </p>

        <p><span class="pre-label">Becomes</span></p>
        <pre class="code code-small">&lt;<span style="color:#e289bc;">p</span>&gt;
  &lt;<span style="color:#e289bc;">a</span> <span style="color:#7ccb90;">aria-label</span>="<span style="color:#c2b957">Air-light GitHub: External site</span>" <span style="color:#7ccb90;">href</span>=<span style="color:#c2b957">"https://github.com/digitoimistodude/air-light"</span>&gt;
    Air-light GitHub
    &lt;<span style="color:#e289bc;">svg</span>
      <span style="color:#7ccb90;">aria-hidden</span>=<span style="color:#c2b957">"true"</span>
      <span style="color:#7ccb90;">xmlns</span>=<span style="color:#c2b957">"http://www.w3.org/2000/svg"</span>
      <span style="color:#7ccb90;">width</span>=<span style="color:#c2b957">"12"</span>
      <span style="color:#7ccb90;">height</span>=<span style="color:#c2b957">"12"</span>
      <span style="color:#7ccb90;">viewBox</span>=<span style="color:#c2b957">"0 0 9 9"</span>&gt;
        &lt;<span style="color:#e289bc;">path</span> d=<span style="color:#c2b957">"M4.499 1.497h4v4m0-4l-7 7"</span>
          <span style="color:#7ccb90;">stroke</span>=<span style="color:#c2b957">"currentColor"</span>
          <span style="color:#7ccb90;">fill</span>=<span style="color:#c2b957">"none"</span>
          <span style="color:#7ccb90;">fill-rule</span>=<span style="color:#c2b957">"evenodd"</span>
          <span style="color:#7ccb90;">stroke-linecap</span>=<span style="color:#c2b957">"round"</span>
          <span style="color:#7ccb90;">stroke-linejoin</span>=<span style="color:#c2b957">"round"</span>&gt;
        &lt;/<span style="color:#e289bc;">path</span>&gt;
      &lt;/<span style="color:#e289bc;">svg</span>&gt;
  &lt;/<span style="color:#e289bc;">a</span>&gt;
&lt;/<span style="color:#e289bc;">p</span>&gt;</pre>
      </div>
    </div>
